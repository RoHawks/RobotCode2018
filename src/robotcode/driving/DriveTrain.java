...
//	}
	...
	public void enactMovement () {
		...
		double linearSpeed = getStickLinearSpeed();
...
//	
	private double getStickLinearSpeed() {
		...
		speed *= speed; //quadratic control, finer control of lower speeds
		speed *= DriveConstants.SwerveSpeeds.SPEED_MULT;		
		return speed;
	}
